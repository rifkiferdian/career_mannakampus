    ...
    <dialog class="admin-modal talent-detail-modal" id="talent-detail-<?= (int) $candidate['id'] ?>" aria-labelledby="talent-detail-title-<?= (int) $candidate['id'] ?>">
        <div class="admin-modal-panel">
            ...
            <div class="talent-detail-body">
                ...
                <div class="talent-detail-footer"><a href="<?= site_url('adminhrdmannakampus/pelamar/' . $candidate['applicant_id']) ?>" target="_blank" rel="noopener noreferrer">Buka profil lengkap</a><?php if ($candidate['whatsapp_number'] !== ''): ?><a class="talent-whatsapp" href="https://wa.me/<?= esc($candidate['whatsapp_number'], 'attr') ?>" target="_blank" rel="noopener noreferrer">Hubungi WhatsApp</a><?php endif ?><button type="button" data-admin-modal-close>Tutup</button></div>
            </div>
        </div>
    </dialog>

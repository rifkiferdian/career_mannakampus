...
<label class="vacancy-checkbox template-active-check"><input type="checkbox" name="is_schedulable" value="1" <?= (int) ($stage['is_schedulable'] ?? 0) === 1 ? 'checked' : '' ?> <?= $isProtected ? 'disabled' : '' ?>><span><strong>Membutuhkan jadwal</strong><small>Saat kandidat masuk ke tahap ini, recruiter wajib mengisi jadwal seleksi.</small></span></label>
